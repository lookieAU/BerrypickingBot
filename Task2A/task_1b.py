...
# Team ID:			[ 1212 ]
# Author List:		[ THIRUMURUGAN B, PLABAN DATTA,ARUNAGIRI T,AMUDHAPRIYAN E ]
# Filename:			task_1b.py
...
def get_vision_sensor_image(client_id):
	...
	return_code = 0
	##############	ADD YOUR CODE HERE	##############
	return_code,sensor_handle=sim.simxGetObjectHandle(client_id,'vision_sensor',sim.simx_opmode_blocking)
	return_code,image_resolution,vision_sensor_image=sim.simxGetVisionSensorImage(client_id,sensor_handle,0,sim.simx_opmode_streaming)
	return_code,sensor_handle=sim.simxGetObjectHandle(client_id,'vision_sensor',sim.simx_opmode_blocking)
	return_code,image_resolution,vision_sensor_image=sim.simxGetVisionSensorImage(client_id,sensor_handle,0,sim.simx_opmode_buffer)
	##################################################
